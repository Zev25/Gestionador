...
public class Tarea {
    ...
    public Tarea(String nombre, Date fechaInicio, Date fechaFin, String categoria, String enlaceArchivo, String prioridad) {
        this.nombre = nombre;
    ...
    public String toString() {
        return nombre + ";" + DATE_FORMAT.format(fechaInicio) + ";" + DATE_FORMAT.format(fechaFin) + ";" + categoria + ";" + enlaceArchivo + ";" + prioridad;
    }
